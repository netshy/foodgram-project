...
def upload_ingredients(csv_file='ingredients.csv'):
    """Заливаем данные из файла ingredients.csv в Таблицу Ingredient
       Делим строку по символу ','. Присваиваем сзначения полям таблицы
       title и dimension соответственно. Если после запятой пустая
       строка - ставим 'г'.Можете поменять это поведение.
